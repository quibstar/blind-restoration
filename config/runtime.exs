...
#
#     PHX_SERVER=true bin/blind_shop start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :blind_shop, BlindShopWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "blindrestoration.com"
  port = String.to_integer(System.get_env("PORT") || "4000")

  config :blind_shop, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
